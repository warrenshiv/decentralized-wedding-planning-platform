...
import { idlFactory } from './wedding_planning.did.js';
export { idlFactory } from './wedding_planning.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_WEDDING_PLANNING;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wedding_planning.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wedding_planning canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wedding_planning.did.js")._SERVICE>}
 */
export const wedding_planning = createActor(canisterId);
