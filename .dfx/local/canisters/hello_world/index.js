...
export const canisterId = process.env.CANISTER_ID_HELLO_WORLD;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hello_world.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hello_world canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hello_world.did.js")._SERVICE>}
 */
export const hello_world = createActor(canisterId);
